    ...
    <footer className="bg-[var(--navy)] text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:border-[var(--gold)] hover:text-[var(--gold)] transition-colors"
              >
          ...
          {/* Propiedades */}
          <div>
            <h3 className="text-[var(--gold)] font-semibold text-sm tracking-widest uppercase mb-4">
              {t('properties')}
            </h3>
            <ul className="space-y-2">
              {propertyLinks.map(({ label, href }) => (
                <li key={href}>
                  <Link href={href} className="text-white/60 hover:text-[var(--gold)] text-sm transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/60">
              ...
              <li>
                <a href="tel:+34691294443" className="hover:text-[var(--gold)] transition-colors">
                  +34 691 294 443
                </a>
              </li>
              <li>
